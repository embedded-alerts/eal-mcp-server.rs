...
Executable repository seed for the canonical public repository `embedded-alerts/eal-mcp-server.rs`.
...
Tracking: `embedded-alerts/.github#4`, GitHub Project #1, and the `github.com/embedded-alerts` Linear project.
