# AGENTS.md — embedded-alerts/eal-mcp-server.rs
...
- GitHub org: [`embedded-alerts`](https://github.com/embedded-alerts)
- Repository: [`embedded-alerts/eal-mcp-server.rs`](https://github.com/embedded-alerts/eal-mcp-server.rs)
- Local checkout: `~/codes/embedded-alerts/eal-mcp-server.rs`
- Linear project: https://linear.app/denman/project/githubcomembedded-alerts-2fb7392497ab
- GitHub org project: https://github.com/orgs/embedded-alerts/projects/1
- Sibling test org: `github.com/embedded-alerts-test` (external/e2e coverage and extra GHA minutes)
- Slack workspace: oresoftware-workspace.slack.com
- Kind: product MCP server for this GitHub org
- Package / service name: `eal-mcp-server`
